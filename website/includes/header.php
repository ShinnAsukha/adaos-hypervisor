...
<nav class="navbar">
    <div class="nav-container">
        ...
        <ul class="nav-links" id="navLinks">
            <li><a href="<?= BASE_URL ?>/index.php" class="<?= $_page === 'index' ? 'active' : '' ?>">Ana Sayfa</a></li>
            <li><a href="<?= GITHUB_REPO ?>" target="_blank" rel="noopener">Docs</a></li>
            <li><a href="<?= BASE_URL ?>/purchase.php" class="<?= $_page === 'purchase' ? 'active' : '' ?>">Lisans Al</a></li>
            <?php if ($_user): ?>
                <li><a href="<?= BASE_URL ?>/dashboard.php" class="<?= $_page === 'dashboard' ? 'active' : '' ?>">Panelim</a></li>
                <li>
                    <a href="<?= BASE_URL ?>/logout.php" class="btn btn-outline btn-sm">Çıkış</a>
                </li>
                <li class="nav-user">
